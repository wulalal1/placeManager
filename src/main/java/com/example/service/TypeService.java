...
public class TypeService {
    ...
    public void add(Type type) {
        ...
        type.setPlaceId(currentUser.getId());
    ...
    public PageInfo<Type> selectPage(Type type, Integer pageNum, Integer pageSize) {
        ...
        if (RoleEnum.PLACE.name().equals(currentUser.getRole())) {
            type.setPlaceId(currentUser.getId());
        }
    ...
    public List<Type> selectByPlaceId(Integer placeId) {
        return typeMapper.selectByPlaceId(placeId);
    }
